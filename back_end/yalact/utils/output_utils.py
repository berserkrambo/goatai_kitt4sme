...
import cv2
from back_end.yalact.utils.box_utils import crop, box_iou, box_iou_numpy, crop_numpy
import torch
import numpy as np
...
def nms(class_pred, box_pred, coef_pred, proto_out, anchors, cfg):
    ...
    # exclude the background class......and all but person
    class_p = class_p[1:2, :]
...
def draw_img(ids_p, class_p, box_p, mask_p, img_origin, draw_boxes=True, draw_mask=True, img_name=None, fps=None):
    if ids_p is None:
        return img_origin
